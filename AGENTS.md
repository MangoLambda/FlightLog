...
- Keep R8 shrinking, resource shrinking, and ABI splits enabled; do not switch to a universal-only build or debug build to save release time, since those changes make the distributable larger or less optimized.
